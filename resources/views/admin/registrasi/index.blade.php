...
<div class="bg-white rounded-2xl overflow-hidden">
    <div class="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50/50">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-1">Kelola berkas fisik, penetapan keahlian jurusan, dan verifikasi status siswa baru.</p>
        </div>
        <a href="{{ route('registrasi.create') }}" class="flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-medium shadow-sm transition-all duration-150">
