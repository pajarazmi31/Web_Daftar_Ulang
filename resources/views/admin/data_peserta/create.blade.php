...
<div class="max-w-5xl mx-auto" x-data="{
    ...
    @endif
        ...
        <div x-show="tab === 'pribadi'" class="bg-white rounded-2xl border border-slate-100 p-6 space-y-4 shadow-sm" x-transition>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="nisn" value="{{ old('nisn') }}" placeholder="Contoh: 0009321234" maxlength="10" class="w-full px-4 py-2 border border-slate-200 rounded-xl font-mono">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="rt" value="{{ old('rt') }}" placeholder="005" class="w-full px-4 py-2 border border-slate-200 rounded-xl font-mono">
                </div>
                <div>
                    <label class="block text-slate-600 font-medium mb-1">14. RW</label>
                    <input type="text" name="rw" value="{{ old('rw') }}" placeholder="011" class="w-full px-4 py-2 border border-slate-200 rounded-xl font-mono">
                </div>
                <div>
                    <label class="block text-slate-600 font-medium mb-1">15. Nama Dusun / Kampung</label>
                    <input type="text" name="dusun" value="{{ old('dusun') }}" class="w-full px-4 py-2 border border-slate-200 rounded-xl">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kode_pos" value="{{ old('kode_pos') }}" class="w-full px-4 py-2 border border-slate-200 rounded-xl font-mono">
                </div>
            </div>
        ...
        <div x-show="tab === 'ibu'" class="bg-white rounded-2xl border border-slate-100 p-6 space-y-4 shadow-sm" x-transition>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="block text-slate-600 font-medium mb-1">34. Nama Ibu Kandung (Wajib Sesuai KK)</label>
